...
| Not ported | mkinitcpio, limine, plymouth, sddm, faillock, nsswitch, ufw-docker | left to Ubuntu | Arch boot stack, no faillock in Ubuntu's PAM, `nsswitch` carries `sss` for the corporate login |
